...
const UserSchema = new mongoose.Schema({
  ...
  attemptedQuestionIds: [{ type: mongoose.Schema.Types.ObjectId, ref: 'Question' }], // Track attempted questions for rotation
...
const CompanySchema = new mongoose.Schema({
  ...
  collegeCutoff: { type: mongoose.Schema.Types.Mixed, default: 'Not available' }, // CGPA or score cutoff
  placementStats: {
    placedCount: { type: Number, default: 0 },
    avgPackage: { type: String, default: 'N/A' }, // e.g. "12 LPA"
    details: { type: String, default: '' }
  },
  roles: { type: [String], default: ['SDE', 'Data Analyst', 'Data Science', 'Machine Learning'] },
...
const RoadmapSchema = new mongoose.Schema({
  ...
  practiceQuestions: [{
    ...
    title: String,
    url: String,
    type: { type: String, enum: ['previously-asked', 'recommended'], default: 'recommended' },
    topicName: String
  }],
  behavioralQuestions: [{
    question: String,
    tip: String,
    sampleAnswer: String,
    type: { type: String, enum: ['previously-asked', 'general'], default: 'general' }
  }],
...
const QuestionSchema = new mongoose.Schema({
  ...
  origin: { type: String, enum: ['curated', 'AI-generated'], default: 'curated' }
}, { timestamps: true });
...
export const BookmarkedQuestion = mongoose.model('BookmarkedQuestion', BookmarkedQuestionSchema);

...
import {
  getCompanyProfile,
  getRoleCompanyProfile,
  getRoleCompanyRoadmap,
  getRoleCompanyQuestions,
  getRoleCompanyHRQuestions,
  ragRetrieve,
...
router.post("/add", requireAuth, async (req, res) => {
  const { name, timeline, collegeCutoff, placedCount, avgPackage, details } =
    req.body;
  if (!name) {
  ...
  try {
    ...
    if (company) {
      console.log(
        `[DEDUP] Reusing existing company "${company.name}" for request "${name}"`,
      );
      ...
      const profileContent = cachedKB
        ? cachedKB.content
        : `### ${company.name} Prep Profile\nNo cached profile details available.`;
      return res.json({
        success: true,
        company,
        reused: true,
    ...
    for (const existing of allCompanies) {
      ...
      if (
        ...
        console.warn(
          `[DEDUP WARNING] New company request "${name}" closely matches existing company name "${existing.name}"`,
        );
      }
    }
    ...
    return res
      .status(201)
      .json({ success: true, company, profile: aiProfile.content });
  } catch (error) {
    return res.status(500).json({ error: error.message });
  }
});
...
router.post("/:id/role-profile", requireAuth, async (req, res) => {
  ...
  try {
    ...
    if (roleProfile) {
      ...
      return res.json({
        profile: roleProfile.content,
        citations: roleProfile.citations,
      });
    }

    console.log(
      `RoleProfile cache miss. Triggering research pipeline for: ${company.name} - ${role}`,
    );
...
router.post("/:id/role-roadmap", requireAuth, async (req, res) => {
  ...
  try {
    ...
    if (!roleProfile) {
      console.log(
        `Generating role profile context on the fly for roadmap: ${company.name} - ${role}`,
      );
    ...
    const generatedRoadmap = await getRoleCompanyRoadmap(
      company.name,
      role,
      roleProfile.content,
      userBranch,
      isCsBranch(userBranch),
    );

    // Parse category classification and markdown body
    const categoryMatch = generatedRoadmap.content.match(
      /\[CATEGORY:\s*([^\]]+)\]/i,
    );
    ...
    if (
      ...
      roleLower.includes("nlp") ||
      roleLower.includes("computer vision")
    ) {
      category = "data-ml";
    } else if (
    ...
    const cleanContent = generatedRoadmap.content.replace(
      /\[CATEGORY:\s*[^\]]+\]\n*/i,
      "",
    );

    console.log(`Generating practice questions for: ${domainName}`);
    const practiceQuestions = await getRoleCompanyQuestions(
      company.name,
      role,
      roleProfile.content,
    );
    ...
    const behavioralQuestions = await getRoleCompanyHRQuestions(
      company.name,
      role,
      roleProfile.content,
    );
          ...
          topics: [
            {
              ...
              whyItMatters:
                "Screener tests are predominantly SQL coding heavy.",
              leetcodeUrl: "https://leetcode.com/tag/database/",
              resources: [
                { title: "SQLZoo Tutorial", url: "https://sqlzoo.net/" },
              ],
            },
          ],
        },
          ...
          topics: [
            {
              ...
              whyItMatters:
                "Core technical interview questions are based on ML internals.",
              leetcodeUrl: "https://leetcode.com/tag/math/",
              resources: [
                {
                  title: "Scikit-Learn Algorithms Guide",
          ...
          topics: [
            {
              ...
              whyItMatters:
                "Standard Product Manager / Business Analyst technical rounds.",
              leetcodeUrl: "",
              resources: [
                {
                  title: "Stratechery Product Strategy",
          ...
          topics: [
            {
              ...
              whyItMatters:
                "Required for technical Product Manager (TPM) rounds.",
              leetcodeUrl: "",
              resources: [
                {
            ...
            topics: [
              {
                ...
                description:
                  "Revise bending moments, shear forces, stress-strain relations, and core structural theories.",
            ...
            topics: [
              {
                ...
                description:
                  "Master open channel flow, pipe networking, Bernoulli principles, and hydraulic structures.",
            ...
            topics: [
              {
                ...
                description:
                  "Review soil mechanics, bearing capacity, foundation designs, and concrete mix criteria.",
                whyItMatters:
                  "Essential for site engineering and validation panels.",
                leetcodeUrl: "",
                resources: [
                  {
                    title: "Geotechnical Guide",
                    url: "https://www.geotechdata.info/",
                  },
                ],
              },
            ],
            ...
            topics: [
              {
                ...
                description:
                  "Deep-dive review of your graduation civil project and bill of quantities estimation basics.",
                whyItMatters: "Final portfolio check by senior project panels.",
                leetcodeUrl: "",
                resources: [
                  {
                    title: "ResearchGate Civil Projects",
            ...
            topics: [
              {
                ...
                description:
                  "Revise KVL/KCL, network theorems, semiconductor diodes, BJTs, and Op-Amp behaviors.",
            ...
            topics: [
              {
                ...
                description:
                  "Master logic gates, flip-flops, state machines, microcontrollers, and register configurations.",
            ...
            topics: [
              {
                ...
                description:
                  "Review 8051/ARM architectures, signal transformations (Fourier/Laplace), and noise filters.",
                whyItMatters:
                  "Essential for telecommunications and hardware panels.",
                leetcodeUrl: "",
                resources: [
                  {
                    title: "ARM Developer Guides",
            ...
            topics: [
              {
                ...
                description:
                  "Review final year electronic projects, circuit simulations, or PCB layouts.",
                whyItMatters:
                  "Final portfolio validation by technical hardware panels.",
                leetcodeUrl: "",
                resources: [
                  {
                    title: "Electronics Projects Hub",
            ...
            topics: [
              {
                ...
                description:
                  "Revise mechanical drawings, limits/tolerances, GD&T, and finite element modeling.",
                whyItMatters: "Required for design challenges.",
                leetcodeUrl: "",
                resources: [
                  {
                    title: "CAD Drafting Basics",
            ...
            topics: [
              {
                ...
                description:
                  "Master heat engines, fluid dynamics, heat transfer, and HVAC systems theory.",
                whyItMatters: "Common core screening topics.",
                leetcodeUrl: "",
                resources: [
                  {
                    title: "Mechanical Thermodynamics NPTEL",
                    url: "https://nptel.ac.in/",
                  },
                ],
              },
            ...
            topics: [
              {
                ...
                description:
                  "Review casting, welding, machining operations, and tensile/hardness testing.",
                whyItMatters: "Essential for manufacturing panels.",
                leetcodeUrl: "",
                resources: [
                  {
                    title: "Manufacturing Video Tutorials",
            ...
            topics: [
              {
                ...
                description:
                  "Review CAD designs, stress analysis reports, or lab fabrications from final year projects.",
                whyItMatters:
                  "Final structural verification by mechanical panel.",
                leetcodeUrl: "",
                resources: [
                  {
                    title: "Mechanical Projects list",
                    url: "https://www.instructables.com/technology/mechanical-engineering/",
                  },
                ],
              },
            ],
            ...
            topics: [
              {
                ...
                description:
                  "Master analytical methods, safety systems, process workflow design, and operational checks.",
                whyItMatters: "Evaluates systems engineering aptitude.",
                leetcodeUrl: "",
                resources: [
                  {
                    title: "Engineering Toolbox Reference",
            ...
            topics: [
              {
                ...
                description:
                  "Review test benches, measurement validation, quality criteria, and fault tree analysis.",
                whyItMatters: "Essential for system operations roles.",
                leetcodeUrl: "",
                resources: [
                  {
                    title: "IEEE Instrumentation Standards",
            ...
            topics: [
              {
                ...
                description:
                  "Detailed walkthrough of academic projects, technical presentations, and core research results.",
            ...
            topics: [
              {
                ...
                description:
                  "Revise process management, SQL databases, indexing, inheritance, encapsulation, and standard interview basics.",
                whyItMatters:
                  "Standard technical screen hurdle for non-CS candidates.",
                leetcodeUrl: "https://leetcode.com/tag/database/",
                resources: [
                  {
                    title: "GeeksforGeeks OS Prep",
            ...
            topics: [
              {
                ...
                description:
                  "Master Arrays, Strings, HashMaps, and Binary Search patterns.",
            ...
            topics: [
              {
                ...
                description:
                  "Master Linked Lists, Stacks, Queues, and Sliding Window technique problems.",
                whyItMatters:
                  "Commonly queried in technical interview round 1.",
                leetcodeUrl: "https://leetcode.com/tag/sliding-window/",
                resources: [
                  {
                    title: "LeetCode Discuss Experiences",
            ...
            topics: [
              {
                ...
                description:
                  "Master DP, Greedy patterns, and Basic System Design / OOPs concepts.",
            ...
            topics: [
              {
                ...
                whyItMatters:
                  "Critical for initial Online Assessment coding tests.",
                leetcodeUrl: "https://leetcode.com/tag/array/",
                resources: [
                  {
              ...
              },
              {
                ...
                description:
                  "Revise the four pillars of OOPs (Inheritance, Polymorphism, Encapsulation, Abstraction) and common design pattern interview questions.",
                whyItMatters: "Highly tested in technical interview panels.",
                leetcodeUrl: "",
                resources: [
                  {
                    title: "Wikipedia OOPs Concepts",
          ...
          },
          {
            ...
            topics: [
              ...
              },
              {
                ...
                description:
                  "Master SQL queries, database normalization, indexing mechanisms, and transactions/ACID properties.",
                whyItMatters:
                  "Extremely common in technical screens and design rounds.",
                leetcodeUrl: "https://leetcode.com/tag/database/",
                resources: [
                  {
                    title: "GeeksforGeeks DBMS Tutorials",
            ...
            topics: [
              {
                ...
                whyItMatters:
                  "Differentiates high-scoring candidates in technical interviews.",
                leetcodeUrl: "https://leetcode.com/tag/tree/",
                resources: [
                  {
                    title: "TakeUForward DSA Sheet",
              ...
              },
              {
                ...
                description:
                  "Master process management, CPU scheduling, memory management (paging/virtual memory), concurrency/synchronization, and deadlocks.",
                whyItMatters:
                  "Crucial for system developer and backend rounds.",
                leetcodeUrl: "",
                resources: [
                  {
                    title: "GeeksforGeeks OS Prep",
          ...
          },
          {
            ...
            topics: [
              ...
              },
              {
                ...
                description:
                  "Revise the OSI/TCP-IP model layers, TCP vs UDP, HTTP/HTTPS basics, DNS lookup flow, and common networking interview questions.",
                whyItMatters:
                  "Tested heavily in networking and backend engineering roles.",
                leetcodeUrl: "",
                resources: [
                  {

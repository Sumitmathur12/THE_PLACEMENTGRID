...
const runVerification = async () => {
  ...
  const mongoUri = process.env.MONGODB_URI || "YOUR_DEFAULT_MONGODB_URI_HERE"; // Replace with your default MongoDB URI if needed
  ...
  console.log(
    "Live Rotation Verification: Initializing live HTTP requests to backend...",
  );
